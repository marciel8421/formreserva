...
<div class=" container-fluid">
	<h3>Pesquisar reserva</h3>
			...
			$filtro = isset($_POST['filtro'])?$_POST['filtro']:"";
				...
				print "<h4>Resultados encontrados na data <strong> $filtro  </strong> das 12:00 às 17:59 hs</h4><br>";
...
<?php 
	...
	$sql = "SELECT SUM(num_pessoas) FROM clientes WHERE  data = '$filtro'AND horario BETWEEN '12:00:00' AND '17:59:00' ORDER BY `data`ASC";
	$sql = $pdo->query($sql);
	if ($sql->rowCount() > 0) {
